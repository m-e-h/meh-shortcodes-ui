...
if ( ! class_exists( 'MEHSC_Template_Loader' ) )  {
	/**
	 * Template loader.
	 *
	...
	class MEHSC_Template_Loader {
		 ...
		 * @type string
		 */
		protected $filter_prefix = 'meh_sc';
		 ...
		 * @type string
		 */
		protected $theme_template_directory = 'meh-sc'; // or 'your-plugin-templates' etc.
		 ...
		 * @type string
		 */
		protected $plugin_directory = MEHSC_PLUGIN_DIR; // or plugin_dir_path( dirname( __FILE__ ) ); etc.
		 ...
		 * @since 1.0.0
		 *
		 * @uses MEHSC_Template_Loader::get_template_possble_parts() Create file names of templates.
		 * @uses MEHSC_Template_Loader::locate_template() Retrieve the name of the highest priority template
		 *     file that exists.
		 *
		 * @param string  $slug
